Namespace Sisvet
    ...
    Public Class ClassBanco
        ...
        Public Function retornaDataTable(ByVal comand As String) As System.Data.DataTable

            'crar um objeto de ligação entre o banc e o conjunto de dados
            Dim da As New Odbc.OdbcConnection(connectionString)
        ...
        Public Function executasql(ByVal sqlcomando As String) As Integer
            ...
            Dim cmd As New Odbc.OdbcCommand(sqlcomando, conn)
