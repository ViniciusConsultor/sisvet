Public Class FormExame
    ...
    Public Sub Carregacombo()
        ...
        ComboLaboratorio.DisplayMember = "NOME"
        ComboLaboratorio.ValueMember = "CODIGO"
        ComboLaboratorio.DataSource = obj.retornaDataTable(" select * FROM  retornalab() AS (CODIGO INTEGER, NOME VARCHAR, TELEFONE CHAR(13), ENDERECO VARCHAR, MUNICIPIO VARCHAR)")
    ...
    Private Sub btsalvar_Click(sender As System.Object, e As System.EventArgs) Handles btsalvar.Click
        ...
        Try
            ...
            ComboLaboratorio.DisplayMember = "NOME"
            ComboLaboratorio.ValueMember = "CODIGO"
            id = ComboLaboratorio.SelectedValue



            Dim result As Integer
            Dim sql As String
            sql = "Select receber_dadosexame('" & txtdescricao.Text & "'," & id & "," & cod & ")"
    ...
    Private Sub btexcluir_Click(sender As System.Object, e As System.EventArgs) Handles btexcluir.Click
        ...
        Else
            ...
            If MsgBox("Tem Certeza Que Deseja Excluir?", MsgBoxStyle.YesNo + MsgBoxStyle.Question, "Excluir") = MsgBoxResult.Yes Then
                If obj.executasql("Select deletar_exame(" & txtcodigo.Text & ")") >= 1 Then
    ...
    Private Sub PreencheGrid()
        ...
        DataGridView1.DataSource = obj.retornaDataTable(" select * FROM  retornaexame() AS (  CODIGO INTEGER, NOME VARCHAR, LABORATORIO INTEGER)")

    End Sub
    Private Sub PreencheGrid(cod As String)
        Dim obj As New Sisvet.ClassBanco

        DataGridView1.DataSource = obj.retornaDataTable(" select * FROM  retornaexame(" & cod & ") AS ( CODIGO INTEGER, NOME VARCHAR, LABORATORIO INTEGER)")
    ...
    Private Sub CarregaCampos()
        ...
        If (DataGridView1.Rows.Count > 0) Then
            ...
            ComboLaboratorio.Text = DataGridView1.Item(2, DataGridView1.CurrentCell.RowIndex).Value
