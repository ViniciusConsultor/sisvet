Public Class FormExameLaboratorial
    ...
    Private Sub btsalvar_Click(sender As System.Object, e As System.EventArgs) Handles btsalvar.Click
        ...
        Try
            ...
            idEx = FormTratamento.combodescricao.SelectedValue

            Dim result As Integer
            Dim sql As String
            sql = "Select receber_dadoslaboratoriais(" & cod & "," & idTrat & "," & idEx & ",'" & txtdescricao.Text & "','" & txtresponsavel.Text & "'," & txtvalor.Text & ")"
    ...
    Private Sub PreencheGrid()
        ...
        DataGridView1.DataSource = obj.retornaDataTable(" select * FROM  retornaexamelaboratorial() AS(PACIENTE VARCHAR, CODIGOEXAM TEXT, RESPONSAVEL TEXT, DESCRICAO VARCHAR, VALOR NUMERIC)")

    End Sub
    Private Sub PreencheGrid(cod As String)
        Dim obj As New Sisvet.ClassBanco

        DataGridView1.DataSource = obj.retornaDataTable(" select * FROM  retornaexamelaboratorial(" & cod & ") AS(PACIENTE VARCHAR, CODIGOEXAM TEXT, RESPONSAVEL TEXT, DESCRICAO VARCHAR, VALOR NUMERIC)")
