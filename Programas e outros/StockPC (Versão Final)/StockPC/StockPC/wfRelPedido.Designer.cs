namespace StockPC
{
    partial class wfRelPedido
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.tbpedidoTableAdapter = new StockPC.estoqueDataSet1TableAdapters.tbpedidoTableAdapter();
            ...
            this.tbpedidoBindingSource.DataSource = this.estoqueDataSet1;
            // 
            // estoqueDataSet1
            // 
            ...
            reportDataSource1.Value = this.tbpedidoBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "StockPC.rptPedido.rdlc";
            this.reportViewer1.Location = new System.Drawing.Point(0, 0);
            this.reportViewer1.Name = "reportViewer1";
            this.reportViewer1.Size = new System.Drawing.Size(1056, 456);
            ...
            this.Name = "wfRelPedido";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Relatório de Pedidos";
            this.Load += new System.EventHandler(this.wfRelPedido_Load);
        ...
        private estoqueDataSet1TableAdapters.tbpedidoTableAdapter tbpedidoTableAdapter;
    }
}