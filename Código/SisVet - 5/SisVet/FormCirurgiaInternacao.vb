Public Class FormCirurgiaInternacao
    ...
    Private Sub FormCirurgiaInternacao_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        Combotratamento.Text = "COD:" & FormTratamento.txtcodigo.Text & "       Cirurgia"
 ...
 Public Sub Carregacombotrat()
    ...
    Private Sub btsalvar_Click(sender As System.Object, e As System.EventArgs) Handles btsalvar.Click
        ...
        Try
            ...
            Dim idcirur As Integer
            Combocirurgia.DisplayMember = "NOME"
            Combocirurgia.ValueMember = "CODIGO"
            idcirur = Combocirurgia.SelectedValue

            Dim result As Integer
            Dim sql As String
            sql = "Select receber_dadosCirurgiaintern(" & idTrat & "," & idcirur & ",'" & txtddescricaon.Text & "','" & txtdata.Text & "','" & txtvalor.Text & "','" & txtvalor.Text & "'," & cod & ")"
