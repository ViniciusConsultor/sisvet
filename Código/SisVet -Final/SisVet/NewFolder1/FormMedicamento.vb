Public Class FormMedicamento
    ...
    Private Sub btsalvar_Click(sender As System.Object, e As System.EventArgs) Handles btsalvar.Click
        ...
        Try
            ...
            Dim sql As String
            sql = " Select receber_dadosmedicamento('" & txtnome.Text & "'," & txtvalor.Text & "," & txtestoque.Text & ",'" & txttipo.Text & "'," & cod & ")"
    ...
    Private Sub CarregaCampos()
        ...
        If (DataGridView1.Rows.Count > 0) Then
            ...
            txtestoque.Text = DataGridView1.Item(3, DataGridView1.CurrentCell.RowIndex).Value
            txttipo.Text = DataGridView1.Item(4, DataGridView1.CurrentCell.RowIndex).Value
